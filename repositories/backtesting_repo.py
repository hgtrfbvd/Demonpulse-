...
class BacktestingRepo:
    ...
    def _build_run_payload(run: dict[str, Any]) -> dict:
        return {
            ...
            "code_filter":      run.get("code_filter") or run.get("race_code", ""),
            ...
            "winner_hit_count": int(run.get("winner_hit_count") or run.get("winner_hits") or 0),
            "top2_hit_count":   int(run.get("top2_hit_count") or run.get("top2_hits") or 0),
            "top3_hit_count":   int(run.get("top3_hit_count") or run.get("top3_hits") or 0),
            "hit_rate":         _to_numeric(run.get("hit_rate") or run.get("winner_accuracy")) or 0.0,
            "top2_rate":        _to_numeric(run.get("top2_rate")) or 0.0,
            "top3_rate":        _to_numeric(run.get("top3_rate")) or 0.0,
    ...
    def _build_item_payload(item: dict[str, Any]) -> dict:
        return {
            ...
            "race_date":            item.get("race_date") or item.get("date"),
            "track":                item.get("track", ""),
            "code":                 item.get("code") or item.get("race_code", ""),
            ...
            "winner_odds":          _to_numeric(item.get("winner_odds") or item.get("win_price")),
