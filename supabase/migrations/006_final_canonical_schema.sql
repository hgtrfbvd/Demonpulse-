-- ================================================================
-- DEMONPULSE V8 — MIGRATION 006: FINAL CANONICAL SCHEMA
-- ================================================================
-- ONE final reconciliation pass that brings the Supabase database
-- fully in line with the current production codebase.
--
-- SOURCE OF TRUTH: current Python code (database.py, migrations.py,
-- ai/learning_store.py, users.py, auth.py, learning_engine.py, etc.)
--
